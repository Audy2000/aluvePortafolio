            ...
            <div className="p-5">
                ...
                <div className='row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3'>
                    ...
                    <Card
                        ...
                        descripcion={"Proyecto Windows Forms para la gestión de Comprobantes Electrónicos"} />
                    ...
                    <Card
                        ...
                        titulo="ASP"
                        descripcion={"Creación de APIs Rest con ASP.NET"} />

                    <Card
                        url_imagen="https://www.qindel.com/wp-content/uploads/2023/04/spring-boot.jpeg"
                        titulo="JAVA- Spring Boot"
                        descripcion={"Creación de APIs Rest con Java Spring Boot"} />
